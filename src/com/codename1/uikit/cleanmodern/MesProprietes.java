...
public class MesProprietes extends BaseForm {
    ...
    public MesProprietes(Resources res) {
        ...
        connectionRequest.setUrl("http://localhost/bmg/afficherProprieteByUser.php?id_u=1");
        ...
        addTab(swipe, res.getImage("news-item.jpg"), spacer1, "15 Likes  ", "85 Comments", "BeMyGuest ");
            ...
            updateArrowPosition(barGroup.getRadioButton(barGroup.getSelectedIndex()), arrow);
               ...
               ProprieteCRUD pc = new ProprieteCRUD();
                ...
                for(Propriete p : pc.getListP(new String(connectionRequest.getResponseData()))){
                    ...
                    addButton(res.getImage("news-item-1.jpg"), p.getPays(), false, 26, 32);
